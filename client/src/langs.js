const langs = {
  id: {
    ...
    'qr.scan.title': 'Pindai untuk login',
    'qr.step1.text': 'Pindai kode QR dengan kamera telepon Anda',
    'qr.step2.text': 'Ketuk tautan untuk membuka',
    'qr.step3.text': 'Pindai kode QR lagi untuk menautkan ke akun Anda',
    'qr.help': 'Perlu bantuan?',
    'qr.keep': 'Tetap masuk di browser ini',
    'qr.link.phone': 'Login dengan nomor telepon',
    'phone.title.short': 'Masukkan nomor telepon',
    'phone.desc.short': 'Pilih negara lalu masukkan nomor telepon Anda.',
    'phone.submit.label': 'Berikutnya',
    'phone.link.qr': 'Login dengan kode QR',
    'code.title.short': 'Masukkan kode di telepon',
    'code.linking': 'Menautkan akun WhatsApp',
    'code.edit': 'edit',
    'code.step1': 'Buka',
    'code.step1.end': 'di telepon',
    'code.step2': 'Di Android ketuk',
    'code.step2.sep': '· Di iPhone ketuk',
    'code.step3': 'Ketuk',
    'code.step3.sep': 'lalu',
    'code.step3.link': 'Perangkat tertaut',
    'code.step3.link2': 'Tautkan perangkat',
    'code.step4': 'Ketuk',
    'code.step4.sep': 'lalu masukkan kode ini di telepon Anda',
    'code.step4.link': 'Tautkan dengan nomor telepon saja',
    'code.link.qr': 'Login dengan kode QR',
    'footer.noaccount': 'Tidak punya akun WhatsApp?',
    'footer.start': 'Mulai',
    'footer.terms': 'Ketentuan & Kebijakan Privasi',
    'menu': 'Menu',
    'settings': 'Pengaturan',
  },
  en: {
    ...
    'qr.scan.title': 'Scan to login',
    'qr.step1.text': 'Scan QR code with your phone camera',
    'qr.step2.text': 'Tap the link to open',
    'qr.step3.text': 'Scan the QR code again to link your account',
    'qr.help': 'Need help?',
    'qr.keep': 'Stay logged in on this browser',
    'qr.link.phone': 'Login with phone number',
    'phone.title.short': 'Enter your phone number',
    'phone.desc.short': 'Select your country and enter your phone number.',
    'phone.submit.label': 'Next',
    'phone.link.qr': 'Login with QR code',
    'code.title.short': 'Enter code on your phone',
    'code.linking': 'Linking WhatsApp account',
    'code.edit': 'edit',
    'code.step1': 'Open',
    'code.step1.end': 'on your phone',
    'code.step2': 'On Android tap',
    'code.step2.sep': '· On iPhone tap',
    'code.step3': 'Tap',
    'code.step3.sep': 'then',
    'code.step3.link': 'Linked Devices',
    'code.step3.link2': 'Link a device',
    'code.step4': 'Tap',
    'code.step4.sep': 'then enter this code on your phone',
    'code.step4.link': 'Link with phone number only',
    'code.link.qr': 'Login with QR code',
    'footer.noaccount': "Don't have a WhatsApp account?",
    'footer.start': 'Get started',
    'footer.terms': 'Terms & Privacy Policy',
    'menu': 'Menu',
    'settings': 'Settings',
  },
}
